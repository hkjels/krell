...
const deviceId = DeviceInfo.getDeviceId() || "Web";

var CONNECTED = false;
var RECONNECT_INTERVAL = 3000;

var SERVER_IP = "$KRELL_SERVER_IP";
var SERVER_PORT = krellPortMap
  ? krellPortMap[deviceId] || $KRELL_SERVER_PORT
  : $KRELL_SERVER_PORT;
...
console.log("Krell sez howdy, Device ID:", deviceId);
